...
function Class(opts)
	...
	local lines = {
		...
		"public:",
		"	"..opts.fargs[1].."();",
		"	"..opts.fargs[1].."("..opts.fargs[1].." const & src);",
		"	~"..opts.fargs[1].."();",
		"	"..opts.fargs[1].." &operator=("..opts.fargs[1].." const & src);",
		"",
		"private:",
		"};",
		"",
	...
	local lines2 = {
		...
		"{}",
		"",
		opts.fargs[1] .. "::" .. opts.fargs[1] .."("..opts.fargs[1].." const & src)",
		"{}",
		"",
		opts.fargs[1] .. "& " .. opts.fargs[1] .."::operator=("..opts.fargs[1].." const & src)",
		"{}",
		""
	}
